SimulationUI <- function(id)
{
  ...
  fluidPage(
    ...
    navbarPage("Steps",
       tabPanel("Purpose",
                box(
                    tags$p("The purpose of this tab is to give users the freedom to produce data with their own hazards using the same simulation that produced the data displayed on the dashboard. 
                            The following tabs show how to use the simulation step-by-step."),
       ...
       tabPanel("2. Formatting the Data",
                box(
       ...
       tabPanel("3. Running the Simulation",
                box(
       ...
       # tabPanel("4.Downloadable Example",
       #          box(
       #            tags$h2(""),
       # 
       # 
       # 
       #            downloadButton(NS(id,"exampleExcel"), "Download Excel Example"),
       #            downloadButton(NS(id,"exampleCSV"), "Download CSV Example"),
       # 
       # 
       # 
       #            width = 12,solidHeader = TRUE
